				...
				<div class="modal-body">
					<table align='center'>
						<tr>
							<td>No KTP</td>
							<td>:</td>
							<td><input type="text" class="form-control" name="no_ktp" placeholder="No KTP" onkeyup="validAngka(this)"></td>
						</tr>
						<tr>
							<td>No RM</td>
							<td>:</td>
							<td><input type="text" class="form-control" name="no_rkm_medis" placeholder="No Rekam Medis" onkeyup="validAngka(this)" style="width:400"></td>
						</tr>
						<tr>
							<td>Tanggal</td>
							<td>:</td>
							<td><input type='text' class="form-control" id='calender' placeholder="Kunjungan" name='tanggal'></td>
						</tr>
						<tr>
							<td align='right'><input type='submit' value='CEK'></td>
							<td align='left'></td>
					...
					<div class="modal-body">
						<table align='center'>
							<tr>
								<td>Nama Pasien</td>
								<td>:</td>
								<td><input type="text" class="form-control" name="nm_pasien" placeholder="No Rekam Medis" value="<?php echo $nm_pasien; ?>" style="width:400" readonly>
									<input type="hidden" class="form-control" name="no_rkm_medis" placeholder="No Rekam Medis" value="<?php echo $no_rkm_medis; ?>" style="width:400" hidden>
								</td>
							</tr>
							<tr>
								<td>Kunjungan</td>
								<td>:</td>
								<td><input type="text" class="form-control" name="tanggal" value="<?php echo $tanggal; ?>" style="width:400" readonly></td>
							</tr>
							<tr>
								<td>Hari</td>
								<td>:</td>
								<td><input type="text" class="form-control" name="hari" value="<?php echo $hari; ?>" style="width:400" readonly></td>
							</tr>
							<tr>
								<td>Pilih Poli</td>
								<td>:</td>
								<td><select class='form-control' name='kd_poli' onchange='showDokter()'>
							...
							<tr>
								<td>Pilih Dokter</td>
								<td>:</td>
								<td><select class="form-control" name="kd_dokter" id="dokter"></select></td>
							</tr>
							<tr>
								<td>ASKES</td>
								<td>:</td>
								<td><select class='form-control' name='kd_penjab'>
							...
							<tr>
								<td>No TLP/HP.</td>
								<td>:</td>
								<td><input type="text" class="form-control" name="no_tlp" maxlength="12" placeholder="021/08X" onkeyup="validAngka(this)"></td>
							</tr>
							<tr>

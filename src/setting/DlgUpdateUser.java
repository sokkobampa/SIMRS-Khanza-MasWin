        ...
        try{    
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    satu_sehat_kirim_medicationdispense=rs.getBoolean("satu_sehat_kirim_medicationdispense");edit_hapus_spo_medis=rs.getBoolean("edit_hapus_spo_medis");edit_hapus_spo_nonmedis=rs.getBoolean("edit_hapus_spo_nonmedis");hasil_usg_neonatus=rs.getBoolean("hasil_usg_neonatus");hasil_endoskopi_faring_laring=rs.getBoolean("hasil_endoskopi_faring_laring");
                    setTampil();
                }       

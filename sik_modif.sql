...
ALTER TABLE `user` MODIFY COLUMN `peminjam_piutang` enum('true','false') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL AFTER `hibah_aset_inventaris`;

...
CREATE TABLE `detail_pemberian_obat_selanjutnya`  (
...
ALTER TABLE `user` MODIFY COLUMN `hasil_usg_neonatus` enum('true','false') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL AFTER `edit_hapus_spo_nonmedis`;

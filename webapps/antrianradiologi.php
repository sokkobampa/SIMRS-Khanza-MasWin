...
<body class="bg">
        ...
        <nav class="deep-orange accent-3">
            <div class="nav-wrapper">
                <ul class="center hide-on-med-and-down" id="nv">
                    <li>
                        <a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">local_hospital</i> Antrian Radiologi</a>
                    </li>
        ...
        <div class="footer-copyright deep-orange accent-3 white-text">
            <div class="container simple-marquee-container" id="footer">
                ...
                <marquee class="marquee" scrollamount="4">
                      <?php 
                        $sql ="select jns_perawatan_radiologi.kd_jenis_prw,jns_perawatan_radiologi.nm_perawatan,jns_perawatan_radiologi.total_byr,jns_perawatan_radiologi.kelas from jns_perawatan_radiologi inner join penjab on penjab.kd_pj=jns_perawatan_radiologi.kd_pj where jns_perawatan_radiologi.status='1' and penjab.png_jawab like '%umum%'";
                        $hasil=bukaquery($sql);
    ...
    <script type="text/javascript"> 
        var auto_refresh = setInterval( 
            function() { 
                $('#data').load('data_antrianradiologi.php').fadeIn("fast"); 
            }, 9000
        );
        var auto_refresh = setInterval( 
            function() { 
                $('#judul').load('data_antrianradiologijudul.php').fadeIn("fast"); 
            }, 9000
        ); 
    </script>
</body>

 ...
 <div class="col s12 row">
    <div class="col s12">
        <table class="default">
            ...
            <tbody>
            <?php  
              $_sql="select permintaan_lab.no_rawat,pasien.nm_pasien,
                    ...
                    if(permintaan_lab.jam_hasil='00:00:00','',permintaan_lab.jam_hasil) as jam_hasil,dokter.nm_dokter
                    ...
                    where permintaan_lab.status='ralan' and permintaan_lab.tgl_permintaan='".date("Y-m-d", $tanggal)."' order by permintaan_lab.jam_permintaan desc" ;  

...
<html lang="en">
<head>
    <title>Antrian Laboratorium Patologi Klinis</title>
        ...
        <nav class="deep-orange accent-3">
            <div class="nav-wrapper">
                <ul class="center hide-on-med-and-down" id="nv">
                    <li>
                        <a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">local_hospital</i> Antrian Laboratorium Patologi Klinis</a>
                    </li>

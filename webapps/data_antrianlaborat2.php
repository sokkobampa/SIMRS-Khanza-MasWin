 ...
 <div class="col s12 row">
    <div class="col s12">
        <table class="default">
            ...
            <tbody>
            <?php  
              $_sql="select permintaan_labpa.no_rawat,pasien.nm_pasien,
                    if(permintaan_labpa.jam_permintaan='00:00:00','',permintaan_labpa.jam_permintaan) as jam_permintaan,
                    if(permintaan_labpa.jam_sampel='00:00:00','',permintaan_labpa.jam_sampel) as jam_sampel,
                    if(permintaan_labpa.jam_hasil='00:00:00','',permintaan_labpa.jam_hasil) as jam_hasil,dokter.nm_dokter
                    ...
                    where permintaan_labpa.status='ralan' and permintaan_labpa.tgl_permintaan='".date("Y-m-d", $tanggal)."' order by permintaan_labpa.jam_permintaan desc" ;  
